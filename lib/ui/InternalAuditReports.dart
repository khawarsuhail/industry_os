...
class InternalAuditReports extends StatefulWidget {
  @override
  _InternalAuditReportsState createState() => _InternalAuditReportsState();
}

class _InternalAuditReportsState extends State<InternalAuditReports> {
  @override
